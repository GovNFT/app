...
import { Tooltip, ToggleSwitch, TextInput, Textarea, Select, Button } from "flowbite-react";
import { Info as InfoIcon, Calendar as CalendarIcon, Plus as PlusIcon, Minus as MinusIcon } from "lucide-react";
        ...
        <div className="lg:flex gap-6">
          <div className="lg:w-8/12 mb-4 lg:mb-0 bg-black/5 dark:bg-white/5 p-6 rounded-lg">
            ...
            <div className="flex items-center bg-black/5 hover:bg-black/[.08] dark:bg-white/5 dark:hover:bg-white/[.08] cursor-pointer rounded px-5 py-4 mb-8">
              <div className="grow uppercase text-xs opacity-40">Nft Settings</div>
            ...
            <div className="px-4 mb-8">
              ...
              <div className="space-y-3 pb-6">
                <div className="flex">
                  <div className="text-xs opacity-20 grow">
                    Vest
                  </div>
                  <div className="text-xs opacity-20">
                ...
                <div className="space-y-3 pb-6 grow">
                  ...
                  <div className="relative">
                    <TextInput
                      value="1"
                    />
                    <Select sizing="sm" className="absolute top-1.5 right-1.5 w-20" color="gray">
                       <option>Mths</option>
                       <option>Years</option>
                    </Select>
                  </div>
            ...
            {/* STEP 2 */}
            <div className="flex items-center bg-black/5 hover:bg-black/[.08] dark:bg-white/5 dark:hover:bg-white/[.08] cursor-pointer rounded px-5 py-4 mb-8">
              <div className="grow uppercase text-xs opacity-40">Nft Info (Optional)</div>
              <PlusIcon size={16} />
            </div>
          ...
          <div className="lg:w-6/12 p-6 sm:p-10 bg-black/[.08] dark:bg-white/[.08] bg-opacity-70 dark:bg-opacity-50 rounded-lg">
            ...
            <div className="space-y-6 pb-8">
              ...
              <div className="space-y-1.5 border-t border-black/5 dark:border-white/5 pt-6">
                ...
                <div>42,300.00</div>
                <div className="text-xs opacity-40">Starts in a month, ends in 3 years</div>
              </div>
            </div>
